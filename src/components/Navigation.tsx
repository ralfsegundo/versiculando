...
export type TabType = 'home' | 'journey' | 'trails' | 'profile' | 'community';
...
const Navigation = React.memo(function Navigation({ currentTab, onTabChange, unreadNotifications = 0 }: NavigationProps) {
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white/98 backdrop-blur-xl border-t border-stone-100 pb-safe z-50"
      ...
      <nav className="max-w-lg mx-auto flex justify-around items-center h-[64px] px-1" aria-label="Navegação principal">
